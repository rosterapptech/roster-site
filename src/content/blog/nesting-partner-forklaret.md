---
title: 'Nesting partner forklaret: at bo sammen i polyamori'
description: 'Hvad er en nesting partner? Begrebet beskriver, hvem du bor sammen med – uanset hvem der er "vigtigst". Definition, afgrænsning og typiske udfordringer.'
pubDate: 2026-07-11
lang: 'da'
translationKey: 'nesting-partner-explained'
tags: ['Nesting Partner', 'Polyamori', 'Relationsformer', 'Samliv']
---

**Kort fortalt:** En nesting partner er den partner, du deler en fælles husholdning – en "rede" – med, uanset hvilket forhold der følelsesmæssigt betyder mest. Begrebet adskiller bevidst boligsituationen fra forholdshierarkiet: du kan bo sammen med nogen uden at den person automatisk er din primære partner, og lige så let have et meget tæt forhold uden at bo under samme tag.

Begrebet "nesting partner" dukker konstant op i poly-fællesskabet, netop fordi konventionelle ord som "samlever" eller "ægtefælle" som standard blander romantisk rangorden sammen med boligsituation. Det holder ikke i polyamori – her er der brug for et begreb, der udelukkende beskriver den praktiske side: hvem deler husleje, køleskab og hverdag med dig?
...
**Hvad betyder nesting partner?**
En nesting partner er den person, du deler en fælles husholdning med – altså bor sammen med, deler økonomi med og organiserer hverdagen sammen med.

**Er nesting partneren automatisk den vigtigste partner?**
Nej. Begrebet beskriver kun boligsituationen, ikke den følelsesmæssige rangorden. Man kan bo sammen med nogen, uden at det forhold betragtes som "primært".

**Kan man have flere nesting partnere?**
Ja, i sjældnere konstellationer som polyfidelitet eller større husstande bor mere end to mennesker sammen. Som regel refererer begrebet dog til den eller de personer, du rent faktisk bor under samme tag med.

**Hvad hvis jeg ikke har en nesting partner?**
Det er helt normalt, især inden for solo-polyamori. Ikke alle forhold behøver eller bør indebære samliv.

**Hvilken app hjælper med at organisere forhold med og uden nesting partner?**
Roster kortlægger hver forbindelse ligeværdigt, uanset boligsituation, så også forhold uden samliv forbliver synlige og velplejede.
