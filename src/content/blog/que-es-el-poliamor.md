---
title: 'Poliamor: ¿qué es exactamente? Significado, definición y lo esencial'
description: 'Poliamor, ¿qué es realmente? Una definición clara, la diferencia con la infidelidad, un breve vistazo al origen del término y quién vive así hoy en día.'
pubDate: 2026-07-08
lang: 'es'
translationKey: 'what-is-polyamory'
tags: ['Poliamor', 'Definición', 'Conceptos básicos', 'Modelos de relación']
faq:
  - q: 'Poliamor, ¿qué es exactamente?'
    a: 'El poliamor significa mantener más de una relación romántica al mismo tiempo, con el conocimiento y el consentimiento de todas las personas implicadas. Se trata de apertura en lugar de secretismo, no principalmente del número de parejas.'
  - q: '¿Cuál es la diferencia entre poliamor e infidelidad?'
    a: 'La diferencia clave es el consentimiento y el conocimiento. En el poliamor, todas las personas implicadas saben unas de otras y han aceptado la configuración. La infidelidad rompe en secreto una exclusividad acordada, sin que la persona engañada esté informada ni haya dado su consentimiento.'
  - q: '¿Es el poliamor lo mismo que una relación abierta?'
    a: 'No exactamente, aunque ambos caen bajo el término general de no monogamia ética. El poliamor suele referirse a varias relaciones románticas con conexión emocional, mientras que las relaciones abiertas suelen centrarse más en contactos sexuales fuera de la relación principal. Los límites son difusos y cada persona los define de forma individual.'
  - q: '¿Hay que seguir reglas concretas para vivir el poliamor?'
    a: 'No, no existen reglas obligatorias. El poliamor va desde modelos muy estructurados y jerárquicos hasta formas muy abiertas y no jerárquicas. Lo importante es que todas las personas implicadas sepan a qué se comprometen y estén de acuerdo con ello.'
---
...
- **Varias relaciones** — no necesariamente dos; pueden ser tres, cuatro o más conexiones a la vez.
- **Al mismo tiempo** — a diferencia de relaciones que se suceden una tras otra, como también las tienen las personas monógamas.
- **Romántico** — el poliamor suele incluir cercanía emocional y enamoramiento, no solo contacto sexual. Justo eso lo distingue de conceptos puramente sexuales como el swinging.
- **Con el conocimiento y consentimiento de todas las personas** — este es el punto central alrededor del cual gira el resto de este artículo.
...
**Poliamor, ¿qué es exactamente?**
El poliamor significa mantener más de una relación romántica al mismo tiempo, con el conocimiento y el consentimiento de todas las personas implicadas. Se trata de apertura en lugar de secretismo, no principalmente del número de parejas.

**¿Cuál es la diferencia entre poliamor e infidelidad?**
La diferencia clave es el consentimiento y el conocimiento. En el poliamor, todas las personas implicadas saben unas de otras y han aceptado la configuración. La infidelidad rompe en secreto una exclusividad acordada, sin que la persona engañada esté informada ni haya dado su consentimiento.

**¿Es el poliamor lo mismo que una relación abierta?**
No exactamente, aunque ambos caen bajo el término general de no monogamia ética. El poliamor suele referirse a varias relaciones románticas con conexión emocional, mientras que las relaciones abiertas suelen centrarse más en contactos sexuales fuera de la relación principal. Los límites son difusos y cada persona los define de forma individual.

**¿Hay que seguir reglas concretas para vivir el poliamor?**
No, no existen reglas obligatorias. El poliamor va desde modelos muy estructurados y jerárquicos hasta formas muy abiertas y no jerárquicas. Lo importante es que todas las personas implicadas sepan a qué se comprometen y estén de acuerdo con ello.
